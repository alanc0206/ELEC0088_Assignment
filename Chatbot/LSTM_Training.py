## Run this script to train and save a new LSTM model. ##
import math
import numpy as np
import pandas as pd
...
# Environment variables for AMD ROCM (comment if not necessary)
...
# Normalise data to a range from 0 to 1
...
# Predict and validate using testing feature vector
